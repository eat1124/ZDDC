...
urlpatterns = [
    ...
    url(r'^reporting_cancel_release/$', reporting_cancel_release),
    url(r'^reporting_save/$', reporting_save),
    url(r'^reporting_supply/$', reporting_supply),
    ...
    # 指标数据查询
    url(r'^target_value_search/(?P<funid>\d+)/$', target_value_search),
    url(r'^get_target_search_data/$', get_target_search_data),

    # 指标统计查询
    url(r'^target_statistic/(?P<funid>\d+)/$', target_statistic),
    ...
    url(r'^target_insert_data/$', target_insert_data),
